...
function dinhDangSanPham(array $row): array
{
    return [
        ...
        'gia_goc'      => isset($row['original_price']) && $row['original_price'] !== null
            ? (int) $row['original_price'] : null,
        ...
        'giam_gia'     => (int) ($row['is_sale'] ?? $row['giam_gia'] ?? 0),
