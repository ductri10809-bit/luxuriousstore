        ...
        <div class="footer-grid">
            <div class="footer-brand">
                <div style="margin-bottom:12px">
                    <img src="<?= SITE_URL ?>/images/logo.png" alt="FROMSHOPWHERE" style="height:50px;width:auto;object-fit:contain;filter:brightness(1.1) drop-shadow(0 0 4px rgba(0,0,0,.4))">
                </div>
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="<?= SITE_URL ?>/products.php">Chỉnh sửa video</a></li>
                    <li><a href="<?= SITE_URL ?>/products.php">Bảo mật</a></li>
                    <li><a href="<?= SITE_URL ?>/products.php">Hệ điều hành</a></li>
                </ul>
            </div>
            <div class="footer-col">
                <h4>Hỗ trợ</h4>
                <ul>
                    ...
                    <li><a href="<?= SITE_URL ?>/contact.php">Câu hỏi thường gặp</a></li>
                    <li><a href="<?= SITE_URL ?>/contact.php">Chính sách đổi trả</a></li>
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="<?= SITE_URL ?>/contact.php">Hợp tác</a></li>
